...
decoder_output = Decoder_cnn(decoder_input, feedback_bits)
...
checkpointer = ModelCheckpoint(filepath='49sep3_1v3_autoencoder.h5', verbose=1, save_best_only=True)
...
encoder.save('49sep3_1v3_encoder_t6.h5')
decoder.save('49sep3_1v3_decoder_cnn.h5')
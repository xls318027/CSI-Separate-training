...
# encoder2: 5-layer transformer
encoderInput = keras.Input(shape=(INPUT_SHAPE))
encoderOutput = Encoder_U(encoderInput, feedback_bits, NUM_QUAN_BITS, EMBEDDING_DIM, NUM_HEAD)
...
checkpointer = ModelCheckpoint(filepath='best_49sep2_3v1_autoencoder.h5', verbose=1, save_best_only=True)
scheduler = tf.keras.callbacks.LearningRateScheduler(scheduler)
earlystop_callback = EarlyStopping(monitor='val_loss', patience=50)

#model training
autoencoderModel.fit(x=x_train_2, y=x_train_2, batch_size=64, epochs=200,
...
encoder.save('49sep2_3v1_encoder_t5.h5')
decoder.save('49sep2_3v1_decoder_t6.h5')